...
text = text.replace(
    ...
    r'\resizebox{0.87\columnwidth}{!}{\input{images/fig1_overview}}'
)

# For figure 4
text = text.replace(
    r'\resizebox{0.85\columnwidth}{!}{\input{images/fig4_block}}',
    r'\resizebox{0.82\columnwidth}{!}{\input{images/fig4_block}}'
)

with open(file_path, 'w', encoding='utf-8') as f:
    f.write(text)

print("Scaled figures down again for authordraft.")
